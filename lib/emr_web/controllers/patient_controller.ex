defmodule EmrWeb.PatientController do
  ...
  def index(conn, _params) do
    patients = Charts.list_patients()
    render(conn, "index.html", patients: patients)
  end

  def new(conn, _params) do
    changeset = Charts.change_patient(%Patient{})
    render(conn, "new.html", changeset: changeset)
  end

  def create(conn, %{"patient" => patient_params}) do
    case Charts.create_patient(patient_params) do
      {:ok, patient} ->
        conn
  ...
  def update(conn, %{"id" => id, "patient" => patient_params}) do
    ...
    case Charts.update_patient(patient, patient_params) do
      {:ok, patient} ->
        conn
  ...
  def delete(conn, %{"id" => id}) do
    patient = Charts.get_patient!(id)
    {:ok, _patient} = Charts.delete_patient(patient)
